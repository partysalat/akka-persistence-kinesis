...
object AggregateManager {
  ...
  case class PendingCommand(sender: ActorRef, targetProcessorId: String, command: BaseAggregate.Command)
}
...
trait AggregateManager extends Actor with ActorLogging {
  ...
  /**
    ...
    */
  def processAggregateCommand(aggregateId: String, command: BaseAggregate.Command) = {
